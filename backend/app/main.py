...
import sqlglot
from backend.app.models import AIAnalyzeResponse, AIOptimizeResponse, FormatResponse, HistoryResponse, StaticAnalyzeResponse
from models import *
...
async def format_sql(req: SqlRequest) -> FormatResponse:
    ...
    try:
        formatted = sqlglot.transpile(req.sql, pretty=True)[0]
